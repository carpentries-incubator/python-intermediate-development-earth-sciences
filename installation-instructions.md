...
- [Command line tool (such as Bash, Zsh or Git Bash)](#command-line-tool)
- [Git version control program](#git-version-control-tool)
- [GitHub account](#github-account)
- [Python 3 distribution](#python-distribution)
- [VS Code integrated development environment (IDE)](#visual-studio-code)
